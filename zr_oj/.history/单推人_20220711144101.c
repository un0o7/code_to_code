...
double convert_time_int(char *time){
    double int result = (time[0]-'0')*10000+(time[1]-'0')*1000+(time[3]-'0')*100+(time[4]-'0')*10+(time[6]-'0')*1+(time[7]-'0')*0.1;
    return result;
}
...
int main(){
    ...
    double time[2][length]; // start and end , each time for 9 chars
    int cost[length];
