#include <stdio.h>
#include <math.h>
long long int convert_time_int(char *time){
    long long int result = (time[0]-'0')*100000+(time[1]-'0')*10000+(time[3]-'0')*1000+(time[4]-'0')*100+(time[6]-'0')*10+(time[7]-'0');
    return result;
}
...
int main(){
    ...
    long long int time[2][length]; // start and end , each time for 9 chars
    int cost[length];
